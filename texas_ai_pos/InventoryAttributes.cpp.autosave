...
InventoryAttributes::InventoryAttributes(int attid, int id, QString att, int q, double p)
{
	attID = attid;
	itemID = id;
	attribute = att;
...
QString InventoryAttributes::getAttribute()
{
	return attribute;
}
...
void InventoryAttributes::setAttribute(QString a)
{
	attribute = a;
}
